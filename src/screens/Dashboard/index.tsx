...
export function Dashboard() {
  ...
  function handleRepositoryPageNavigation(id: number) {
    /**
     * TODO - navigate to the Repository screen sending repository id.(FEITO)
        ...
        <AddGithubRepo>
          ...
          <Input>
            <InputField
              ...
              value={inputText}
              /**
               * TODO - update inputText value when input text value (FEITO)
               * changes:
            ...
            <InputButton
              ...
              /**
               * TODO - ensure to disable button when inputText is (FEITO)
